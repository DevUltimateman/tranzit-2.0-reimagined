...
main() 
{
	replacefunc( maps\mp\zm_transit_fx::precache_scripted_fx, ::precache_scripted_fx_replacer );
	replacefunc( maps\mp\zm_transit_fx::precache_createfx_fx, ::precache_createfx_fx_replacer );
...
precache_scripted_fx_replacer() //checked matches cerberus output
{
...
precache_createfx_fx_replacer() 
{
	...
	level._effect[ "fx_zmb_tranzit_light_glow_fog" ] = loadfx( "maps/zombie/fx_zmb_tranzit_light_glow_fog" ); //TEST WTF IS THIS
	...
	//level._effect[ "fx_zmb_lava_river" ] = loadfx( "maps/zombie/fx_zmb_lava_river" ); //THESE WERE NOT COMMENTED OUT HERE LIKE THEY WERE IN CSC FILE
	//level._effect[ "fx_zmb_lava_creek" ] = loadfx( "maps/zombie/fx_zmb_lava_creek" ); //THESE WERE NOT COMMENTED OUT HERE LIKE THEY WERE IN CSC FILE	
	...
	//level._effect[ "fx_zmb_tranzit_lava_distort" ] = loadfx( "maps/zombie/fx_zmb_tranzit_lava_distort" );//THEHRRRRRRRRRRRRRRRRRRRRRRRRR //CAN BE COMMENTED OUT SINCE THEY ONLY AFFECT FIRE
	//level._effect[ "fx_zmb_tranzit_lava_distort_sm" ] = loadfx( "maps/zombie/fx_zmb_tranzit_lava_distort_sm" );//THEHRRRRRRRRRRRRRRRRRRRRRRRRR //CAN BE COMMENTED OUT SINCE THEY ONLY AFFECT FIRE
	//level._effect[ "fx_zmb_tranzit_lava_distort_detail" ] = loadfx( "maps/zombie/fx_zmb_tranzit_lava_distort_detail" );//THEHRRRRRRRRRRRRRRRRRRRRRRRRR //CAN BE COMMENTED OUT SINCE THEY ONLY AFFECT FIRE
	//level._effect[ "fx_zmb_tranzit_fire_med" ] = loadfx( "maps/zombie/fx_zmb_tranzit_fire_med" );								//THEHRRRRRRRRRRRRRRRRRRRRRRRRR //CAN BE COMMENTED OUT SINCE THEY ONLY AFFECT FIRE
	//level._effect[ "fx_zmb_tranzit_fire_lrg" ] = loadfx( "maps/zombie/fx_zmb_tranzit_fire_lrg" );								//THEHRRRRRRRRRRRRRRRRRRRRRRRRR //CAN BE COMMENTED OUT SINCE THEY ONLY AFFECT FIRE
