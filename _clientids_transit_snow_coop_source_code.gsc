...
init()
{
...

    {
		...
		//This will just call the method the map uses for give_personality_characters or give_team_characters without all the includes and it works on NukeTown as well.
...
setPlayersToSpectator() //required for map_restart to work properly
{
...
setToSpectator() //required for map_restart to work properly
{
...
spawnAllPlayers() //required for map_restart to work properly
{
	players = get_players();
	i = 0;
	while ( i < players.size )
...
dayNightCycle() // day & night cycle for Tranzit 2.0 with r_exposure; //move this to init if the game allows it
{
    ...
    while ( 1 )
    {
        ...
        foreach( players in level.players )
        {
            ...
            nightnumber = randomIntRange( 1, 60 ); //1, 55
            ...
            daynumber = randomIntRange ( 1, 45 ); // 1, 27
...
hook_is_player_in_screecher_zone()
{
    return 0;
}
// self = the model
monitorHide()
{
    ...
    { 
        ...
        if ( distance2D(self.origin, player.origin) < 8500 )
        {
            self show();
...
corn61()
{
    setCustomModel((7700.49, 1351.72, -116.664), (0, 13.0201, 0), 0, "t5_foliage_tree_burnt03");
}
...
bridge39()
{
    setCustomModel((-4986.62, 572.731, 145.293), (0, -37.4742, 0), 0, "t5_foliage_tree_burnt03");
}
...
// needed 2 trees and collision for exiting the town
remaining22()
{
...
remaining32()
{
    setCustomModel((-4153.17, -2524.16, 224.221), (0, -113.482, 0), 0, "t5_foliage_tree_burnt03");
}

remaining33()
{
    setCustomModel((-2107.72, -1182.86, 3.4418), (0, 33.8177, 0), 0, "t5_foliage_tree_burnt03");
}

remaining34()
{
    setCustomModel((-1667.25, -1362.5, -102.145), (0, 78.6529, 0), 0, "t5_foliage_tree_burnt03");
}

remaining35()
{
    setCustomModel((-2050.17, -1564.86, -104.616), (0, -160.371, 0), 0, "t5_foliage_tree_burnt03");
}

remaining36()
{
    setCustomTowers_AlwaysVisible((-8605.63, -6464.64, 167.278), (0, -15.1834, 0), 0, "t5_foliage_tree_burnt03");
}

remaining37()
{
    setCustomTowers_AlwaysVisible((-8605.84, -6464.61, 163.773), (0, -15.1834, 0), 0, "collision_player_64x64x256");
}

remaining38()
{
    setCustomTowers_AlwaysVisible((-8413.02, -6572.86, 107.685), (0, -17.0621, 0), 0, "t5_foliage_tree_burnt03");
}

remaining39()
{
    setCustomTowers_AlwaysVisible((-8410.2, -6573.73, 139.407), (0, -17.0621, 0), 0, "collision_player_64x64x256");
}

remaining40()
{
    setCustomTowers_AlwaysVisible((-6302.96, -7122.87, -61.8546), (0, 56.1563, 0), 0, "collision_player_64x64x256");
}

remaining41()
{
    setCustomTowers_AlwaysVisible((-7758.1, -7255.95, 55.7458), (0, 136.12, 0), 0, "t5_foliage_tree_burnt03");
}

remaining42()
{
    setCustomTowers_AlwaysVisible((-8398.69, -7950.51, 54.6419), (0, 54.4314, 0), 0, "t5_foliage_tree_burnt03");
}

remaining43()
{
    setCustomTowers_AlwaysVisible((-9321.75, 8219.34, -211.836), (0, -31.113, 0), 0, "t5_foliage_tree_burnt03");
}

remaining44()
{
    setCustomTowers_AlwaysVisible((7008.42, -4631.4, -97.1252), (0, -55.8711, 0), 0, "t5_foliage_bush05");
}

remaining45()
{
    setCustomTowers_AlwaysVisible((6825.26, -4746.1, -110.354), (0, 144.355, 0), 0, "t5_foliage_bush05");
}
remaining46()
{
    setCustomTowers_AlwaysVisible((6808.24, -4847.21, -109.004), (0, 129.996, 0), 0, "t5_foliage_bush05");
}

remaining47()
{
    setCustomTowers_AlwaysVisible((7458.94, -1986.42, -283.915), (0, 67.3955, 0), 0, "t5_foliage_tree_burnt03");
}

remaining48()
{
    setCustomTowers_AlwaysVisible((-9145.48, 7918.12, -138.798), (0, -47.2684, 0), 0, "t5_foliage_tree_burnt03");
}
...
remaining51()
{
    setCustomModel((8430.75, 2765.78, -130.358), (0, 92.8445, 0), 0, "t5_foliage_bush05");
}

remaining52()
{
    setCustomModel((8465.35, 2866.39, -131.652), (0, 93.3279, 0), 0, "t5_foliage_bush05");
}

remaining53()
{
    setCustomModel((8495.3, 4950.62, -402.3), (0, 58.8034, 0), 0, "t5_foliage_bush05");
}


remaining54()
{
    setCustomModel((8517.38, 4876.22, -379.614), (0, 18.3187, 0), 0, "t5_foliage_bush05");
}

remaining55()
{
    setCustomModel((8387.68, -1925.78, -298.264), (0, 73.4591, 0), 0, "t5_foliage_tree_burnt03");
}

remaining56()
{
    setCustomModel((7846.04, -2587.27, -246.867), (0, 20.9774, 0), 0, "t5_foliage_bush05");
}

remaining57()
{
    setCustomModel((7914.51, -2589.65, -226.321), (0, 21.5432, 0), 0, "t5_foliage_bush05");
}

remaining58()
{
    setCustomModel((7634.03, -2850.33, -174.439), (0, -1.33581, 0), 0, "t5_foliage_bush05");
}

remaining59()
{
    setCustomModel((7524.31, -2848.79, -176.015), (0, 7.28846, 0), 0, "t5_foliage_bush05");
}

remaining60()
{
    setCustomModel((7405.75, -2872.61, -171.106), (0, 31.0958, 0), 0, "t5_foliage_bush05");
}

remaining61()
{
    setCustomModel((7327.22, -2891.79, -166.258), (0, 36.1166, 0), 0, "t5_foliage_bush05");
}

remaining62()
{
    setCustomModel((6909.34, -3657.8, -76.8671), (0, 89.988, 0), 0, "t5_foliage_bush05");
}

remaining63()
{
    setCustomModel((6912.57, -5888.93, -87.6976), (0, 52.8707, 0), 0, "t5_foliage_shrubs02");
}

remaining64()
{
    setCustomModel((6902.31, -5944.58, -90.4294), (0, 85.4507, 0), 0, "t5_foliage_shrubs02");
}

remaining65()
{
    setCustomModel((6935.98, -5929.44, -119.73), (0, 168.634, 0), 0, "t5_foliage_tree_burnt03");
}
...
diner17()
{
    setCustomModel((-6319.25, -7105.3, -88.263), (0, -32.2507, 0), 0, "t5_foliage_tree_burnt03");
}
...
busstation34()
{
    setCustomModel((-4681.81, 6483.46, 95.5973), (0, -178.326, 0), 0, "t5_foliage_tree_burnt03");
}
busstation35()
{
...
busstation36()
{
    setCustomModel((-5586.5, 6094.63, -81.0404), (0, -112.557, 0), 0, "t5_foliage_tree_burnt03");
}
busstation37()
{
...
busstation57()
{
    setCustomModel((-9535.12, 4600.45, 53.3986), (0, 8.67043, 0), 0, "t5_foliage_tree_burnt03");
}
busstation58()
{
